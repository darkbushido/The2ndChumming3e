...
function initSearch() {
  ...
  request.open('GET', '/The2ndChumming3e/v0.6.1/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/The2ndChumming3e/v0.6.1/assets/css/just-the-docs-' + theme + '.css');
}
