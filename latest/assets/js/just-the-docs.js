...
function initSearch() {
  ...
  request.open('GET', '/The2ndChumming3e/latest/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/The2ndChumming3e/latest/assets/css/just-the-docs-' + theme + '.css');
}
