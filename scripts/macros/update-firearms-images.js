// ════════════════════════════════════════════════════════════════════════════
//  SR3E — Set default image for all items in the sr3e-firearms compendium
...
ui.notifications.info(`SR3E: ${updates.length} firearm image${updates.length !== 1 ? 's' : ''} updated.`);
