...
/** Skill categories the sheet buckets as "Active" — see SR3E.skillTypeForCategory / config.js. */
const _ACTIVE_SKILL_CATS = new Set([
  'Combat skills', 'Build/Repair skills', 'Magical skills', 'Physical skills',
  'Social skills', 'Technical skills', 'Vehicle skills',
]);

/**
 * Resolve the real SR3ESkills category for a skill name + tier via the live config
 * (game.sr3e.SR3E.skills). A bare 'active'/'knowledge'/'language' string doesn't match
 * any real category name, so the sheet's category-based Active/Knowledge/Language
 * grouping (SR3EActorSheet._skillType) fell through to "knowledge" for everything —
 * this is why every skill in the compendium showed up in the same bucket.
 */
function _resolveSkillCategory(name, tier) {
  if (tier === 'language') return 'Language';
  const allCats  = game.sr3e?.SR3E?.skills ?? {};
  const bareName = name.replace(/\s*B\/R\s*$/i, '').trim();
  const tierCats = Object.keys(allCats).filter(cat =>
    tier === 'active' ? _ACTIVE_SKILL_CATS.has(cat) : !_ACTIVE_SKILL_CATS.has(cat) && cat !== 'Language'
  );
  for (const cat of tierCats) {
    const list = (allCats[cat] ?? []).map(s => s.name);
    if (list.includes(name) || list.includes(bareName)) return cat;
  }
  // No exact match (bracketed placeholders, homebrew names, B/R variants, etc.) —
  // fall back to a same-tier bucket so it still groups correctly.
...
const CONTACTS = [
  ...
  // ── p.38 — Who Watches the Watchmen? ────────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Unarmed Combat', 4, 'strength'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Unarmed Combat', 3, 'strength'),
  ...
  // ── p.39 — Who Watches the Watchmen? (cont.) ─────────────────────────────
  {
    ...
    items: [
      ...
      skill('Veterinary Medicine', 4, 'intelligence', 'knowledge'),
  ...
  },
  {
    ...
    items: [
      ...
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Display Link', 0.45),
      cyberware('Headware Memory [150 Mp]', 0.15, 'Standard', 'Headware'),
  ...
  // ── p.40 — Who Watches the Watchmen? (cont.) ─────────────────────────────
  {
    ...
    items: [
      ...
      skill('Heavy Weapons', 5, 'strength'),
      skill('Intimidation', 3, 'charisma'),
      skill('Navigation', 3, 'intelligence'),
      skill('Stealth', 4, 'quickness'),
      skill('Unarmed Combat', 5, 'strength'),
      skill('Wilderness Survival', 4, 'willpower'),
      skill('[Relevant Language]', 3, 'intelligence', 'knowledge'),
      skill('Desert Wars', 4, 'intelligence', 'knowledge'),
      skill('Mercenary Groups', 5, 'intelligence', 'knowledge'),
      skill('Mercenary Hotspots', 4, 'intelligence', 'knowledge'),
      skill('Military Procedures', 4, 'intelligence', 'knowledge'),
      skill('Napoleonic Miniatures', 3, 'intelligence', 'knowledge'),
      skill('War History', 5, 'intelligence', 'knowledge'),
      cyberware('Bone Lacing (Plastic)', 0.5, 'Standard', 'Skeletal'),
      cyberware('Cybereyes', 0),
      cyberware('Thermographic', 0),
      cyberware('Flare Compensation', 0.1, 'Standard', 'Sensory'),
      cyberware('Muscle Replacement 2', 2, 'Standard', 'Muscular'),
      cyberware('Smartlink 2', 0),
      cyberware('Wired Reflexes 2', 3, 'Standard', 'Neural'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Electronics', 6, 'intelligence', 'active', 'Control Systems 8, Diagnostics 7, Security Systems 7'),
      skill('Gunnery', 5, 'intelligence'),
      skill('Launch Weapons', 5, 'intelligence'),
      skill('Pistols', 3, 'quickness'),
      ...
      skill('Weapon Systems', 5, 'intelligence', 'knowledge'),
      cyberware('Cybereyes', 0),
      cyberware('Flare Compensation', 0.1, 'Standard', 'Sensory'),
      cyberware('Low Light', 0),
      cyberware('Thermographic', 0),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Rigger Control Rig 3', 5.4),
      armor('Armor Jacket', 5, 3),
  ...
  // ── p.41 — The Show Must Go On ───────────────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Interrogation', 5, 'charisma'),
      skill('Stealth', 3, 'quickness', 'active', 'Alertness 4, Sneaking 4'),
      ...
      cyberware('Cyberears', 0),
      cyberware('Hearing Amplification', 0),
      cyberware('Recorder', 0),
      cyberware('Cybereyes', 0),
      cyberware('Low Light', 0),
      cyberware('Opticam', 1.3),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [300 Mp]', 0.3, 'Standard', 'Headware'),
      armor('Lined Coat', 4, 2),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Current Events', 5, 'intelligence', 'knowledge'),
      skill('Journalism', 5, 'intelligence', 'knowledge'),
      skill('Noir Ebooks', 4, 'intelligence', 'knowledge'),
      skill('Political Leaders', 3, 'intelligence', 'knowledge'),
      skill('Reporting', 4, 'intelligence', 'knowledge'),
      cyberware('Cybereyes', 0),
      cyberware('Electronic Vision Magnification 3', 0),
      cyberware('Opticam', 0),
      cyberware('Data Compactor 2', 0),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [300 Mp]', 0.3, 'Standard', 'Headware'),
      cyberware('Voice Modulator', 1.65),
      gear('Sony Cybercam'),
  ...
  // ── p.42 — The Show Must Go On (cont.) ───────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Trideography', 4, 'intelligence', 'knowledge'),
      skill('Zombie Sims', 4, 'intelligence', 'knowledge'),
      cyberware('Commlink 4', 0),
      cyberware('Cyberear', 0),
      cyberware('Display Link', 0),
      cyberware('Image Link', 0),
      cyberware('Opticam', 0),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [150 Mp]', 0.15, 'Standard', 'Headware'),
      cyberware('Headware Telephone', 0),
  ...
  // ── p.43 — The Show Must Go On (cont.) ───────────────────────────────────
  {
    ...
    items: [
      skill('Athletics', 3, 'body', 'active', 'Dancing 5'),
      skill('Etiquette', 2, 'charisma', 'active', 'Corporate 3, Club 5'),
      skill('Unarmed Combat', 1, 'strength'),
      skill('Accounting (or other appropriate profes- sional skill)', 3, 'intelligence', 'knowledge'),
      ...
      cyberware('Cosmetic Cybereyes', 0.2),
  ...
  },
  {
    ...
    items: [
      ...
      cyberware('Cosmetic Cybereyes', 0),
      cyberware('Simlink', 0),
      cyberware('Simrig', 2.6),
      bioware('Clean Metabolism', 0),
      bioware('Dietware', 0.4),
      gear('Tres Chic Clothing'),
      gear('Saab Dynamit'),
    ],
  },
  ...
  },
  {
    ...
    items: [
      skill('Computer', 2, 'intelligence'),
      skill('Etiquette', 3, 'charisma', 'active', 'Corporate 4, Political 5, Street 4'),
      skill('Leadership', 4, 'charisma', 'active', 'Political 5'),
  ...
  // ── p.45 — By Any Means Necessary (cont.) ────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Unarmed Combat', 2, 'strength'),
      ...
      skill('Public Relations', 4, 'intelligence', 'knowledge'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Unarmed Combat', 6, 'strength'),
      ...
      skill('Megacorps', 4, 'intelligence', 'knowledge'),
      skill('Terrorist Groups', 5, 'intelligence', 'knowledge'),
      cyberware('Boosted Reflexes 1', 0.5, 'Standard', 'Neural'),
      cyberware('Cybereyes', 0),
      cyberware('Flare Compensation', 0.1, 'Standard', 'Sensory'),
      cyberware('Opticam', 0),
      cyberware('Thermographic', 0),
      cyberware('Smartlink 2', 0.9),
  ...
  // ── p.46 — By Any Means Necessary (cont.) ────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Nerps', 5, 'intelligence', 'knowledge'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Unarmed Combat', 5, 'strength'),
      skill('[Relevant Cause]', 6, 'intelligence', 'knowledge'),
      skill('[Relevant Language]', 4, 'intelligence', 'knowledge'),
      ...
      skill('Trid Pirates', 3, 'intelligence', 'knowledge'),
      cyberware('Boosted Reflexes 1', 0.5, 'Standard', 'Neural'),
      cyberware('Muscle Replacement 2', 2, 'Standard', 'Muscular'),
      cyberware('Smartlink 2', 0),
  ...
  // ── p.47 — Here Come the Suits ───────────────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Shoes', 4, 'intelligence', 'knowledge'),
      skill('State-of-the-Art Science', 6, 'intelligence', 'knowledge'),
      cyberware('Cybereyes', 0),
      cyberware('Display Link', 0),
      cyberware('Image Link', 0),
      cyberware('Low Light Vision', 0),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [150 Mp]', 0.15, 'Standard', 'Headware'),
      cyberware('Headware Telephone', 1.05),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Local Runners', 8, 'intelligence', 'knowledge'),
      ...
      cyberware('Boosted Reflexes 1', 0.5, 'Standard', 'Neural'),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Cyber Implant Weapon (Retractable Spur)', 0),
      cyberware('Smartlink 2', 2.8),
  ...
  // ── p.48 — Here Come the Suits (cont.) ───────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Sports', 3, 'intelligence', 'knowledge'),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [150 Mp]', 0.15, 'Standard', 'Headware'),
      cyberware('(Essence Adjustment)', 0.35),
  ...
  },
  {
    ...
    items: [
      ...
      cyberware('Flare Compensation', 0.1, 'Standard', 'Sensory'),
      cyberware('Low Light', 0),
      cyberware('Muscle Replacement 1', 1, 'Standard', 'Muscular'),
      cyberware('Reaction Enhancers 2', 0.6, 'Standard', 'Neural'),
      cyberware('Wired Reflexes 2', 3, 'Standard', 'Neural'),
      cyberware('Reflex Trigger', 0),
      armor('Tres Chic Armored Clothing', 3, 0),
  ...
  // ── p.49 — Here Come the Suits (cont.) ───────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Local Microbreweries', 6, 'intelligence', 'knowledge'),
      skill('LTG Familiarity', 4, 'intelligence', 'knowledge'),
      skill('Security Network Familiarity', 5, 'intelligence', 'knowledge'),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Encephalon 2', 2, 'Standard', 'Neural'),
      cyberware('Headware Memory [300 Mp]', 0.3, 'Standard', 'Headware'),
      cyberware('Data Compactor 2', 0.75),
      cyberware('Math SPU 3', 0.2, 'Standard', 'Neural'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Corporate Politics', 2, 'intelligence', 'knowledge'),
      ...
      cyberware('Cybereyes', 0),
      cyberware('Image Link', 0),
      cyberware('Microscopic Vision', 0),
      cyberware('Thermographic', 0.9),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [300 Mp]', 0.3, 'Standard', 'Headware'),
  ...
  // ── p.50 — Down and Dirty ────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      cyberware('Flamboyant Cybereyes', 0),
      cyberware('Low Light', 0),
      cyberware('Thermographic Vision', 0.2, 'Standard', 'Sensory'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Car', 3, 'reaction'),
      skill('Computer', 1, 'intelligence', 'active', 'Cybernetics 3'),
      skill('Electronics', 2, 'intelligence', 'active', 'Cybertechnology 5'),
      skill('Etiquette', 3, 'charisma', 'active', 'Street 6'),
      skill('Intimidation', 7, 'charisma'),
      skill('Pistols', 5, 'quickness'),
      skill('Stealth', 4, 'quickness', 'active', 'Sneaking 5, Hiding 6'),
      skill('Unarmed Combat', 4, 'strength'),
  ...
  // ── p.51 — Down and Dirty (cont.) ────────────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Gang Hangouts', 4, 'intelligence', 'knowledge'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Unarmed Combat', 2, 'strength'),
      skill('Bunraku Parlors', 3, 'intelligence', 'knowledge'),
      skill('Fetishes', 5, 'intelligence', 'knowledge'),
      skill('Local Cops', 4, 'intelligence', 'knowledge'),
      skill('Prostitution', 4, 'intelligence', 'knowledge'),
      skill('Psychology', 3, 'intelligence', 'knowledge'),
  ...
  // ── p.52 — Down and Dirty (cont.) ────────────────────────────────────────
  {
    ...
    items: [
      skill('Athletics', 2, 'body'),
      skill('Car B/R', 2, 'intelligence'),
      ...
      skill('Squat Locations', 6, 'intelligence', 'knowledge'),
  ...
  // ── p.53 — Crime, Inc: The Underworld ────────────────────────────────────
  {
    ...
    items: [
      skill('Edged Weapons', 4, 'strength', 'active', 'Katana 6'),
      ...
      skill('English', 4, 'lan', 'knowledge'),
      skill('Japanese', 6, 'lan', 'knowledge'),
  ...
  },
  {
    ...
    items: [
      ...
      cyberware('Boosted Reflexes 3', 0.5, 'Standard', 'Neural'),
      cyberware('Cybereyes', 0),
      cyberware('Low Light', 0),
      cyberware('Thermographic', 0),
      cyberware('Muscle Replacement 1', 1, 'Standard', 'Muscular'),
      cyberware('Smartlink 2', 3),
      armor('Armor Jacket', 5, 3),
      gear('HK-227S'),
  ...
  // ── p.54 — Crime, Inc (cont.) ────────────────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Edged Weapons', 5, 'strength'),
      ...
      skill('Triad Signs 4 Adept Powers: Great Leap', 2, 'intelligence', 'knowledge'),
      skill('Improved Reflexes', 2, 'intelligence', 'knowledge'),
      skill('Mystic Armor', 3, 'intelligence', 'knowledge'),
  ...
  // ── p.55 — Crime, Inc (cont.) ────────────────────────────────────────────
  {
    ...
    items: [
      skill('Computer', 3, 'intelligence'),
      skill('Electronics', 2, 'intelligence'),
      skill('Etiquette', 2, 'charisma', 'active', 'Street 4, Gambling 5'),
      ...
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [150 Mp]', 0.15, 'Standard', 'Headware'),
      cyberware('Headware Telephone', 0.85),
      armor('Armor Jacket', 5, 3),
      gear('Predator 2'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Intimidation', 4, 'charisma', 'active', 'Verbal 6'),
      ...
      cyberware('Cybereyes (Opticam)', 0),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [300 Mp]', 0.3, 'Standard', 'Headware'),
      cyberware('Headware Telephone', 1.7),
      gear('Tailored Clothing'),
      gear('Briefcase'),
      gear('Pocket Secretary'),
  ...
  // ── p.56 — Sinless in Seattle ─────────────────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Fine Wines', 6, 'intelligence', 'knowledge'),
      ...
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [300 Mp]', 0.3, 'Standard', 'Headware'),
      cyberware('Headware Telephone', 1.4),
  ...
  },
  {
    ...
    items: [
      skill('Assault Rifle', 6, 'quickness'),
      skill('Athletics', 5, 'body'),
      skill('Edged Weapons', 6, 'strength'),
      ...
      skill('Goblin Rock', 4, 'intelligence', 'knowledge'),
      skill('Local Gangs', 5, 'intelligence', 'knowledge'),
      skill('Local Mafia', 5, 'intelligence', 'knowledge'),
      skill('Local Yakuza Clans', 5, 'intelligence', 'knowledge'),
      skill('Rumor Mill', 7, 'intelligence', 'knowledge'),
      cyberware('Muscle Replacement 2', 2, 'Standard', 'Muscular'),
      cyberware('Smartlink 2', 1.5),
      cyberware('Wired Reflexes 1', 2, 'Standard', 'Neural'),
      gear('FN HAR'),
      gear('Combat Axe'),
      gear('Pocket Secretary'),
  ...
  // ── p.57 — Sinless in Seattle (cont.) ────────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Pistol', 5, 'quickness'),
      skill('[3 Relevant Languages]', 4, 'intelligence', 'knowledge'),
      ...
      cyberware('Headware Memory [300 Mp]', 0.3, 'Standard', 'Headware'),
      cyberware('Headware Telephone', 0),
      cyberware('Induction Datajack', 1.5),
      armor('Trés Chic Armored Clothing', 3, 0),
  ...
  // ── p.58 — Sinless in Seattle (cont.) ─────────────────────────────────────
  {
    ...
    items: [
      ...
      skill('Heavy Weapons B/R', 4, 'intelligence'),
      skill('Gunnery', 4, 'intelligence'),
      skill('Negotiation', 3, 'charisma'),
      skill('Pistols', 4, 'quickness'),
      skill('Pistols B/R', 8, 'intelligence'),
      skill('Rifles', 6, 'quickness'),
      skill('Rifles B/R', 8, 'intelligence'),
      skill('Submachine Guns', 4, 'quickness'),
      skill('Submachine Guns B/R', 5, 'intelligence'),
      ...
      cyberware('Cyberears', 0),
      cyberware('Select Sound Filter 5', 0),
      cyberware('Sound Dampener', 0),
      cyberware('Cybereyes', 0),
      cyberware('Display Link', 0),
      cyberware('Electronic Magnification 3', 0),
      cyberware('Low Light', 0),
      cyberware('Smartlink 2', 0),
      cyberware('Wired Reflexes 1', 2, 'Standard', 'Neural'),
      armor('Armor Jacket', 5, 3),
  ...
  },
  {
    ...
    items: [
      ...
      cyberware('Cybereyes', 0),
      cyberware('Opticam', 0),
      cyberware('Electronic Visual Magnification 3', 0.3),
  ...
  // ── p.59 — Workin' the Mojo ──────────────────────────────────────────────
  {
    ...
    items: [
      ...
      skill('[2 Ancient Languages]', 4, 'intelligence', 'knowledge'),
      ...
      skill('Magic History', 8, 'intelligence', 'knowledge'),
      skill('Magic Theory', 6, 'intelligence', 'knowledge'),
      skill('Metaplanes', 4, 'intelligence', 'knowledge'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Anthropology', 5, 'intelligence', 'knowledge'),
      skill('Botany', 3, 'intelligence', 'knowledge'),
      skill('Greek', 3, 'lan', 'knowledge'),
      skill('Latin', 4, 'lan', 'knowledge'),
  ...
  // ── p.60 — Workin' the Mojo (cont.) ──────────────────────────────────────
  {
    ...
    items: [
      skill('Aura Reading', 4, 'intelligence'),
      skill('Conjuring', 5, 'willpower'),
      skill('Enchanting', 6, 'willpower', 'active', 'Artificing 8'),
      ...
      skill('Smithing', 6, 'intelligence', 'knowledge'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Enchanting', 4, 'willpower', 'active', 'Alchemy 6'),
      skill('Negotiation', 4, 'charisma', 'active', 'Bargaining 6'),
      skill('Pistols', 4, 'quickness'),
      skill('Sorcery', 4, 'willpower'),
      skill('Archaeology', 3, 'intelligence', 'knowledge'),
      skill('Appraisal', 4, 'intelligence', 'knowledge', 'Magic Items 6'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Etiquette', 4, 'charisma', 'active', 'Academic 6, Magical 8'),
  ...
  // ── p.62 — To Serve and Protect ───────────────────────────────────────────
  {
    ...
    items: [
      ...
      cyberware('Thermographic', 0),
      cyberware('Electronic Vision Magnification 3', 0),
      cyberware('Cyberlegs (Cyberholster in right leg)', 0),
      cyberware('Smartlink 2', 1.7),
      cyberware('Vehicle Control Rig 2', 4, 'Standard', 'Matrix'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Terrorist Groups', 4, 'intelligence', 'knowledge'),
      cyberware('Cybereyes', 0, 'Alphaware'),
      cyberware('Electronic Vision Magnification 3', 0),
      cyberware('Low Light', 0),
      cyberware('Thermographic', 0),
      cyberware('Smartlink 2', 0.44),
      cyberware('Reaction Enhancers 2', 0.6, 'Standard', 'Neural'),
  ...
  // ── p.63 — To Serve and Protect (cont.) ──────────────────────────────────
  {
    ...
    items: [
      ...
      skill('All Night Diners', 3, 'intelligence', 'knowledge'),
      skill('Law', 5, 'intelligence', 'knowledge'),
      ...
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [150 Mp]', 0.15, 'Standard', 'Headware'),
      cyberware('Headware Radio 5', 0),
      cyberware('Smartlink 2', 1.9),
      armor('Lined Coat', 4, 2),
  ...
  },
  {
    ...
    items: [
      skill('Clubs', 3, 'strength'),
      skill('Etiquette', 1, 'charisma', 'active', 'Corporate 2, Street 2'),
      skill('Submachine Guns', 5, 'quickness'),
      skill('Unarmed Combat', 4, 'strength'),
      skill('City Knowledge', 5, 'intelligence', 'knowledge'),
      skill('Matrix Games', 3, 'intelligence', 'knowledge'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Prison Gangs', 4, 'intelligence', 'knowledge'),
      skill('Psychology', 4, 'intelligence', 'knowledge', 'Prison Populations 6'),
  ...
  // ── p.65 — Essential Services: Workers ───────────────────────────────────
  {
    ...
    items: [
      ...
      skill('City Knowledge', 5, 'intelligence', 'knowledge'),
      skill('Medicine', 3, 'intelligence', 'knowledge'),
      skill('Pharmacy', 4, 'intelligence', 'knowledge'),
      ...
      cyberware('Low Light', 0),
      cyberware('Thermographic', 0),
      cyberware('Headware Radio 5', 0.95),
      armor('Armor Jacket', 5, 3),
      gear('Medkit', 5),
      gear('Slap Patches'),
    ],
  },
  {
    ...
    items: [
      ...
      skill('Etiquette', 4, 'charisma', 'active', 'Corporate 5, Medical 6'),
      ...
      cyberware('Cybereyes', 0, 'Betaware'),
      cyberware('Image Link', 0),
      cyberware('Microscopic Vision', 0.34),
      cyberware('Datajack', 0.2, 'Standard', 'Headware'),
      cyberware('Headware Memory [300 Mp]', 0.3, 'Standard', 'Headware'),
      bioware('Cerebral Booster 1', 0.6, 'Standard', 'Neurological'),
      bioware('Clean Metabolism', 0),
      bioware('Mnemonic Enhancer 2', 0.6, 'Standard', 'Neurological'),
      gear('Tailored Clothing'),
      gear('Pocket Secretary'),
  ...
  // ── p.66 — Essential Services: Workers (cont.) ───────────────────────────
  {
    ...
    items: [
      ...
      skill('Biotech', 5, 'intelligence', 'active', 'First Aid 7, Magical Health 8, Surgery 6'),
      skill('Conjuring', 6, 'willpower'),
      ...
      skill('Magic Background', 4, 'intelligence', 'knowledge'),
      skill('Medicine', 5, 'intelligence', 'knowledge'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Clubs', 4, 'strength'),
      skill('Demolitions', 3, 'intelligence'),
      skill('Gunnery', 2, 'intelligence', 'active', 'Water Cannon 4'),
      skill('Polearms/Staffs', 4, 'quickness'),
      skill('Spray Weapons', 3, 'strength', 'active', 'Firehose 5'),
      skill('Unarmed Combat', 3, 'strength'),
      ...
      cyberware('Boosted Reflexes 1', 0.5, 'Standard', 'Neural'),
      cyberware('Tracheal (Air) Filter 10', 1),
  ...
  // ── p.67 — Essential Services: Workers (cont.) ───────────────────────────
  {
    ...
    items: [
      skill('Athletics', 3, 'body'),
      skill('Car', 2, 'reaction', 'active', 'Forklift 4'),
      skill('Intimidation', 3, 'charisma'),
      skill('Unarmed Combat', 3, 'strength'),
      skill('Hard Liquor', 3, 'intelligence', 'knowledge'),
      skill('Local Bars', 5, 'intelligence', 'knowledge'),
  ...
  },
  {
    ...
    items: [
      ...
      skill('Athletics', 2, 'body', 'active', 'Climbing 4'),
      skill('Car', 2, 'reaction'),
      skill('Computer', 2, 'intelligence'),
...
if (!pack) {
  ...
  const ownNames = new Set(CONTACTS.map(c => c.name));
  const ownExisting = existing.filter(d => ownNames.has(d.name));
  let mode = 'create';
  if (existing.length > 0) {
    mode = 'cancel';
    await foundry.applications.api.DialogV2.wait({
      window: { title: "Mr. Johnson's Contacts — Already Populated" },
      content: `<p>The compendium already contains <strong>${existing.length}</strong> document(s),
                <strong>${ownExisting.length}</strong> of which match this macro's contact names.</p>
                <p>Clear those entries and recreate them, add more on top (duplicates), or cancel?</p>`,
      buttons: [
        { label: 'Clear & Recreate', action: 'clear', default: true, callback: () => { mode = 'clear'; } },
        { label: 'Add Anyway (duplicates)', action: 'add', callback: () => { mode = 'create'; } },
  ...
  if (mode !== 'cancel') {
    ...
    if (mode === 'clear' && ownExisting.length > 0) {
      await pack.documentClass.deleteDocuments(ownExisting.map(d => d.id), { pack: pack.collection });
    }
